...
{"headline":"","field":"","profession":"broad profession e.g. Pharmacy, Medicine, Engineering","methods":"comma separated real skills","total_experience_years":"","age":"","achievements":["awards, medals, distinctions"],"research_papers":[{"title":"","venue":"","year":""}],"city":"","address":"","email":"","education":[{"level":"","degree":"","institution":"","city":"","year":"","grade":""}],"publications":["full citation strings"],"experience":[{"role":"","org":"","city":"","years":""}],"certifications":["named certifications"],"trainings":["named trainings, workshops, short courses"],"licenses":[{"name":"","body":"","number":""}],"links":{"orcid":"","scholar":"","linkedin":""},"phone":"","referees":[{"name":"","title":"","institution":"","email":"","relationship":""}]}` });
