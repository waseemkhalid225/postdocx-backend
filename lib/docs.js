...
{"headline":"","field":"","profession":"broad profession e.g. Pharmacy, Medicine, Engineering","professions":["ALL professional identities from ALL degrees, e.g. a PharmD with PhD Pharmacology is BOTH Pharmacist and Pharmacologist; a BSN nurse with MPH is Nurse and Public Health Professional"],"methods":"comma separated real skills","total_experience_years":"","age":"","achievements":["awards, medals, distinctions"],"research_papers":[{"title":"","venue":"","year":""}],"city":"","address":"","email":"","education":[{"level":"","degree":"","institution":"","city":"","year":"","grade":""}],"publications":["full citation strings"],"experience":[{"role":"","org":"","city":"","years":""}],"certifications":["named certifications"],"trainings":["named trainings, workshops, short courses"],"licenses":[{"name":"","body":"","number":""}],"links":{"orcid":"","scholar":"","linkedin":""},"phone":"","referees":[{"name":"","title":"","institution":"","email":"","relationship":""}]}` });
  ...
  try { await admin().from('app_settings').upsert({ key: 'profilex:' + userId, value: { at: new Date().toISOString(), x: { profession: v.profession || '', professions: (v.professions || []).slice(0, 5), total_experience_years: v.total_experience_years || '', age: v.age || '', achievements: (v.achievements || []).slice(0, 12), research_papers: (v.research_papers || []).slice(0, 15), city: v.city || '', address: v.address || '', email: v.email || '', certifications: (v.certifications || []).slice(0, 20), trainings: (v.trainings || []).slice(0, 20), education: (v.education || []).slice(0, 10), experience: (v.experience || []).slice(0, 12) } } }); } catch (e) {}
