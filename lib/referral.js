...
// RULE: every N qualified referrals earns one free Solo credit. Credits accumulate,
      ...
      if (!error) {
        ...
        try {
          await admin().from('support_tickets').insert({
            user_id: referrerId, subject: 'You earned a free Solo credit',
            ...
            reply: 'Congratulations. You have earned ' + cfg.credits_per_milestone +
              ' free Solo package credit. It is valid until ' +
