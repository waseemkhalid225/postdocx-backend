...
const BRAVE_QUERIES = [
  'fully funded masters scholarship 2026 international students Europe',
  'fully funded PhD position 2026 apply',
  'postdoc position open apply deadline',
  'pharmacist jobs Saudi Arabia visa sponsorship',
  'nurse vacancy Qatar UAE hospital careers',
  'scholarship international students Canada Australia deadline'
];
