...
const SCHEMA = {
  Users: ['id','name','email','passHash','role','title','field','methods','pubs','prefs','links','orcid','nationality','phone','smtpEmail','encPass','emailConnected','partnerId','active','createdOn','jobPrefs','minSalary','jobLocations','schedLink'],
  Researchers: ['id','name','title','email','field','methods','pubs','prefs','links','active','partnerId'],
  Opportunities: ['id','resId','title','institution','country','pi','url','deadline','funding','status','matchScore','note','dupKey','addedOn','verifiedOn','coupleKey','category','level','compensation','section','requirements','stipend','duration','chance','nextSteps','analyzedOn','readiness','archived','prepStatus','prepStartedAt','prepDone','parentOppId'],
