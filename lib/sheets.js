...
const SCHEMA = {
  Users: ['id','name','email','passHash','role','title','field','methods','pubs','prefs','links','orcid','nationality','phone','smtpEmail','encPass','emailConnected','partnerId','active','createdOn','jobPrefs','minSalary','jobLocations'],
