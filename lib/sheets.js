...
const SCHEMA = {
  ...
  Opportunities: ['id','resId','title','institution','country','pi','url','deadline','funding','status','matchScore','note','dupKey','addedOn','verifiedOn','coupleKey','category','level','compensation','section','requirements','stipend','duration','chance','nextSteps','analyzedOn','readiness','archived'],
