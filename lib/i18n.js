...
const T = {
  nav_dashboard: { en: 'My journey', ur: 'ڈیش بورڈ', hi: 'डैशबोर्ड', bn: 'ড্যাশবোর্ড', ar: 'لوحة التحكم' },
  nav_profile: { en: 'Profile', ur: 'پروفائل', hi: 'प्रोफ़ाइल', bn: 'প্রোফাইল', ar: 'الملف الشخصي' },
  nav_workspace: { en: 'FF-CRM', ur: 'ورک اسپیس', hi: 'वर्कस्पेस', bn: 'ওয়ার্কস্পেস', ar: 'مساحة العمل' },
