...
const DEFAULTS = {
  ...
  packages: {
    tiers: [
      ...
      { key: 'basic', name: 'Basic', credits: 2, view: 5, pkr: 5000, feats: ['See your 5 best-matched opportunities', 'Choose and apply to any 2 of them', 'Customized documents prepared for each position, from official pages'] },
      { key: 'smart', name: 'Smart', credits: 5, view: 8, pkr: 15000, featured: true, feats: ['See your 8 best-matched opportunities', 'Choose and apply to any 5 of them', 'Customized documents prepared for each position you choose'] },
      { key: 'premium', name: 'Premium', credits: 10, view: 20, pkr: 30000, feats: ['See your 20 best-matched opportunities', 'Choose and apply to any 10 of them', 'Re-search with new filters anytime for 6 months', 'Priority preparation of every case'] },
    ]
  },
