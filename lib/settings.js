...
const DEFAULTS = {
  ...
  plus: { tiers: [{ key: 'basic_plus', name: 'Basic +', usd: 59, from: 'basic' }, { key: 'smart_plus', name: 'Smart +', usd: 49, from: 'smart' }, { key: 'premium_plus', name: 'Premium +', usd: 39, from: 'premium' }], includes: ['offer_pack', 'visa_desk', 'interview_pack', 'arrival_pack', 'residence_year'] },
