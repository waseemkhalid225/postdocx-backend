...
async function renderProposalPdf(proposalId) {
  ...
  pdf.font('Helvetica-Bold').fontSize(13.5).text(pRow.title.replace(/^(Tailored CV|Cover letter[^:]*|Concept note|Funding application|Interview brief|Two-body dossier): ?/i, ''));
