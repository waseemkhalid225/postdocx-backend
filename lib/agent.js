...
`Search the web for the official email address of ${opp.pi || 'the supervising professor of this position'} at ${opp.institution}. Search the full name with the university name. Check the university staff directory, the official faculty profile page, the lab website, and the position posting itself. Respond ONLY with a JSON array of addresses you literally SAW on those official pages, university domain first, up to 3, never guessed or constructed: ["..."] or []`,
...
module.exports = { runCycle, cfg, draftProposal, interviewBrief, coupleDossier, weeklyReview, draftRefereeRequests, tailoredCV, coverLetter, setRuntimeMode, loadRuntimeMode, targetLabMap, fundingNarrative, sendOne, analyzeCase, piInsight, computeReadiness, buildReminders, migrateNaming, draftEmailForCase };
